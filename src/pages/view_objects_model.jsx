...
import { FirstJsonClass, api_root, keep_current_object, keep_for_edit_name, keep_for_view_url, keep_m_name, keep_objects_data, keep_objects_data_reference, keep_objects_reference, save_for_object_view, store_first_json, store_form_data } from "../api/api_variables";
...
export default function ViewObjectsModel() {
  ...
  useEffect(() => {
    ...
    let [is_double_clk, set_is_double_clk]= useState(true);
    ...
    const show_obj_d_= (obj) => {
      try{
        console.log(keep_for_object_view[obj].comment_box);
