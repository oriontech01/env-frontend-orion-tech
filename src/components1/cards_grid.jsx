...
const CardsGrid= ({show_data}) => {
    ...
    return(
        <div className="flex flex-col justify-center items-center mx-[5%] mt-[8rem]">
            ...
            <button onClick={navigate_page} className="hover:bg-[#714E2C] hover:border-white hover:text-white border border-[#714E2C] text-[#714E2C] font-bold text-[15px] px-20 py-3 rounded-2xl">View All</button>
            {/* <Link to="/view-all">
            </Link>          */}
        </div>
    );
